...
.card:hover .stroke {
 ...
 border-radius: 25px;
  ...
  <head>
  <center>
  <h3 style="background-color:#0FBDAA;">Change Password</h3>
  </center>
    <meta charset="utf-8">
...
<div>
 <a href = "userprofile.php?customer_id=<?php echo $customer_id?>"><button style="color:black; width: 200px; margin-top: 0px; margin-left: 250px;">< Profile</button></a>
</div>
