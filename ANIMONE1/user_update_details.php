...
.card:hover .stroke {
 ...
 border-radius: 25px;
  ...
  <head>
  <center>
  <h3 style="background-color:#0FBDAA;">Modify Details</h3>
  </center>
...
<div>
 <a href = "userprofile.php?customer_id=<?php echo $customer_id?>"><button style="color:black; width: 100px; margin-top: 0px; margin-left: 0px;">< Profile</button></a>
</div>

<div>
 <a href = "dbook.php?customer_id=<?php echo $customer_id?>"><button style="color:black; width: 100px; margin-top: 0px; margin-left: 0px;">< Home</button></a>
</div>
